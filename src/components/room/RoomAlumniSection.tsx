    ...
    <div className="space-y-6" id="room-alumni-section">
      ...
      >
        <div className="flex items-center gap-3.5">
          ...
          >
            <GraduationCap className="w-5 h-5 text-[#C46F18] dark:text-[#C88D3A]" />
          </div>
          <div>
            <h3
          ...
          >
            <div>
              ...
              <div
                ...
                style={{
                  backgroundColor: isDark ? 'rgba(42, 34, 28, 0.5)' : '#FAE5C5',
                  borderColor: isDark ? 'rgba(200, 141, 58, 0.2)' : '#CF9F68',
                }}
              >
                <Calendar className="w-3.5 h-3.5 text-[#C46F18] dark:text-[#C88D3A] shrink-0" />
                <span style={{ color: isDark ? '#D9C4AC' : '#5A3013' }}>
                  Lived here: <strong className="font-semibold text-[#432006] dark:text-[#FFF9EE]">{alumnus.residencyPeriod}</strong>
                </span>
              </div>
              ...
              {alumnus.publicNote && (
                <div
                  ...
                  style={{
                    backgroundColor: isDark ? 'rgba(42, 34, 28, 0.35)' : '#FAE5C5',
                    borderColor: isDark ? 'rgba(200, 141, 58, 0.2)' : '#CF9F68',
                    color: isDark ? '#E5D6C5' : '#432006',
                  }}
                >
                  <Quote className="w-3 h-3 text-[#C46F18] dark:text-[#C88D3A] inline mr-1 opacity-70" />
